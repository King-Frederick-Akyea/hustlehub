...
import com.hustlehub.rentals.config.UploadsProperties;
...
public class LocalListingImageStorageService implements ListingImageStorageService {

    private static final Logger log = LoggerFactory.getLogger(LocalListingImageStorageService.class);
    ...
    @Override
    public StoredFile store(UUID listingId, MultipartFile file) {
        ...
        try {
            Path dir = Path.of(properties.getBaseDir(), listingId.toString());
    ...
    public void delete(String storagePath) {
        try {
            ...
            log.warn("Failed to delete listing image file {}: {}", storagePath, e.getMessage());
        }
    }
}
